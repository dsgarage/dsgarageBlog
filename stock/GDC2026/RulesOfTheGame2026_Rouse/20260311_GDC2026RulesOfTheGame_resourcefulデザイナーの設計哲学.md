...
![セッション全体の要点を先に提示した「5つの掟」スライド](images/gdc2026_rotg_five_rules.jpg)
...
![セッション冒頭で示された「Pizzazz First, Polish Later（まず華やかさ、磨くのは後）」などのキーワード。10:33頃のオープニングスライド](images/gdc2026_rotg_opening_quotes.jpg)
...
![Theresa Duringer のトーク導入。10:35頃の「Trust」タイトルスライド](images/gdc2026_rotg_trust_title.jpg)
...
![Temple Gates の実例。信頼を稼ぐ UI と可読性を示すプレイ画面スライド](images/gdc2026_rotg_trust_example.jpg)
...
F2P（Free-to-Play、基本無料）ゲーム、モバイルゲームなど、プレイヤーが最初から警戒心を持つジャンルでは、**信頼残高がマイナスからのスタート**になることがあります。しかし克服はできる。
...
> （さあ、プレイヤーの信頼を稼いで、それを惜しみなく使って、輝くような体験を作れ。）
...
> 私が新しいゲームの制作を始めるとき、最初に考えるのはひとつのことだ。このゲームは、私が頭の中に持っている**イノベーション・スペクトラム（革新度の連続的なスケール）**のどこに位置するか。
...
![Steve Meretzky が整理した「革新の利点」。10:49頃の benefits of innovation スライド](images/gdc2026_rotg_innovation_benefits.jpg)
...
![Steve Meretzky が示したバランス感覚。10:50頃の「One third the same, one third improved, one third new」スライド](images/gdc2026_rotg_innovation_balance.jpg)
...
![Joel Burgess の核心フレーズ。10:54頃の「Better? or just Different?」スライド](images/gdc2026_rotg_better_or_different.jpg)
...
![Joel Burgess が示した評価の基準。Sid Meier（『シヴィライゼーション』シリーズの生みの親）の「Double it or cut it in half（倍にするか半分にしろ——中途半端な調整は意味がない）」を引いた判断スライド](images/gdc2026_rotg_judge_the_work.jpg)
...
![Ashley Ruhl のトーク導入。11:00頃の「Create “Fake” Choices That Matter」スライド](images/gdc2026_rotg_fake_choices.jpg)
...
![Ashley Ruhl が示した Illusion Choices の具体例。Mass Effect の会話 UI を用いたロールプレイスライド](images/gdc2026_rotg_illusion_choice_example.jpg)
...
![Ashley Ruhl の結論スライド。選択は分岐量ではなく、その瞬間の意味づけで決まると示している](images/gdc2026_rotg_choices_matter_quote.jpg)
...
![Xalavier Nelson Jr の自己紹介スライド。11:20頃の登壇パート開始時点](images/gdc2026_rotg_xalavier_title.jpg)
...
> 私はこれを **「Atlas Design（地図帳設計——プロジェクトの全要素を"語れるもの"として地図のように俯瞰する設計思想）」** と呼んでいる。プロジェクトのあらゆる要素について問え：「これは開発の**前・中・後**に、話題にして共有できるか？」
...
> （プレイヤーに「このゲームを気にかける理由」を与えろ。そうすれば来てくれる、留まってくれる、もっと気にかける理由を自ら探してくれる。）
...
Rules of the Game シリーズの過去の回はGDC Vault（GDCの過去講演アーカイブサイト。有料会員向けだが、一部の講演は無料で公開されている）で視聴可能です。各スピーカーの掟を自分のプロジェクトに当てはめてみることが、最も実践的な活用方法です。
---
