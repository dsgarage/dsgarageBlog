...
![API呼び出しフロー](images/01_api_flow.png)
...
![StateGraph構造](images/02_stategraph_structure.png)
...
> ![TODO: スクリーンショット](images/ss_stategraph_editor.png)
> *Unity Editor で SimpleUIFlow.asset を開いた状態。4つのステートがトランジションで接続されている*
...
> ![TODO: スクリーンショット](images/ss_flowgraph_nodes.png)
> *Title ステートを開いた状態。CustomEvent と TriggerStateTransition が trigger ポートで接続されている*
...
> ![TODO: スクリーンショット](images/ss_inspector_statemachine.png)
> *UIFlowManager の Inspector。StateMachine コンポーネントの Source が Macro、SimpleUIFlow.asset が割り当てられている*
...
> ![TODO: スクリーンショット](images/ss_hierarchy_scene.png)
> *完成したシーンの Hierarchy。UICanvas 配下に4つのパネル、UIFlowManager に StateMachine + UIFlowManager コンポーネント*

---

![バイブコーディングの罠](images/03_vibe_coding_traps.png)
