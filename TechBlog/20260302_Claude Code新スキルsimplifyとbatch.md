---
title: "Claude Code新スキル /simplify と /batch"
subtitle: "Unity開発のPRワークフローとコードマイグレーションを自動化する"
author: "dsgarage"
date: "2026-03-02"
emoji: "🔧"
type: "tech"
topics: ["Unity", "ClaudeCode", "AI", "開発効率化"]
published: false
---

# Claude Code新スキル /simplify と /batch
...
![/simplifyワークフロー](images/simplify_flow.png)
...
![/batchアーキテクチャ](images/batch_parallel.png)
...
実際にこのプロジェクト（UnityMCP_TestProject）で行った UniTask → IEnumerator 変換のような作業を、全テストファイルに一括適用できます。
...
重複した `EditorGUILayout` 呼び出しの統合、不要な `null` チェックの削除、テストのセットアップ共通化などを自動実行。

---

## 従来ワークフローとの比較

![ワークフロー比較](images/unity_workflow_comparison.png)
